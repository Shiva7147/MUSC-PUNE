...
export const ContactSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // TODO: CONNECT CONTACT FORM RESEND / SUPABASE ENDPOINT

    setSubmitted(true);
  };

  return (
    <section id="contact" className="py-24 bg-[#070707] relative border-t border-neutral-900">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div>
              <div className="flex items-center gap-2 text-xs font-mono text-[#C8102E] font-bold tracking-widest uppercase">
                ...
                <span>DIGITAL MEMBER PASS & CONTACT</span>
              </div>
              <h2 className="font-display text-4xl sm:text-6xl font-bold text-white mt-1 uppercase">
                JOIN <span className="text-[#C8102E]">PUNE REDS</span>
              </h2>
              <p className="text-sm text-neutral-400 mt-2 font-sans">
                Fill out your details to send an enquiry and watch your official digital Red Card pass update live in real-time.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              <div className="p-4 rounded-2xl bg-neutral-900 border border-neutral-800 flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-neutral-400 font-mono mt-0.5">
                    Phoenix Marketcity • Main Screening Arena (300+ Capacity)
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-neutral-900 border border-neutral-800 flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-neutral-400 font-mono mt-0.5">
                    35A Main Road • Open-Air Garden Screening Hub
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 bg-neutral-900 border border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-2xl">
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#C8102E]"
                    />
                  </div>
                ...
                {/* Submit Button */}
                {/* TODO: CONNECT CONTACT FORM API */}
                <button
                  type="submit"
                  className="w-full bg-[#C8102E] hover:bg-[#870019] text-white font-display text-base tracking-wider font-bold py-4 rounded-xl shadow-xl glow-neon-red flex items-center justify-center gap-2 transition-all hover:scale-[1.01]"
                >
