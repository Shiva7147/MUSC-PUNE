  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-center items-center overflow-hidden bg-[#050505] pt-32 sm:pt-36 pb-16">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Subtle Vignette & Top/Bottom Lighting Overlays */}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#171717]/90 border border-white/20 text-[#F5F5F5] font-display text-sm font-bold uppercase shadow-2xl backdrop-blur-md">
          <span className="w-2.5 h-2.5 rounded-full bg-[#E60012] animate-ping" />
          <span>MANCHESTER UNITED SUPPORTERS CLUB • PUNE</span>
        </div>

        {/* UNIFIED HEADLINE: PUNE. UNITED. ALWAYS. */}
        <h1 className="font-display text-6xl sm:text-8xl md:text-9xl lg:text-[10rem] font-bold text-white uppercase leading-[0.9] drop-shadow-[0_15px_30px_rgba(0,0,0,0.95)]">
        ...
        {/* 2 MAIN PROMINENT CTA BUTTONS (CLEAN UNIFIED FONT SPACING) */}
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md sm:max-w-xl mx-auto w-full px-2">
          ...
          <button
            ...
            className="w-full sm:w-auto flex-1 bg-[#E60012] hover:bg-[#C40010] text-white font-display text-2xl sm:text-3xl font-bold py-4 px-8 rounded-3xl shadow-[0_10px_35px_rgba(230,0,18,0.5)] flex items-center justify-center gap-2.5 transition-all hover:scale-[1.03] active:scale-95 border border-white/20 uppercase"
          >
          ...
          <Link
            href="/about"
            className="w-full sm:w-auto flex-1 bg-[#050505]/90 hover:bg-[#171717] text-[#F5F5F5] border border-white/30 hover:border-white font-display text-2xl sm:text-3xl font-bold py-4 px-8 rounded-3xl shadow-xl flex items-center justify-center gap-2.5 transition-all hover:scale-[1.03] active:scale-95 uppercase backdrop-blur-md"
          >
        ...
        <div className="pt-4">
          <button
            onClick={toggleAudio}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#171717]/90 border border-white/20 hover:border-[#E60012] text-[#F5F5F5] font-display text-xs sm:text-sm font-bold uppercase transition-all hover:scale-105 backdrop-blur-md shadow-lg"
          >
            {isPlayingAudio ? (
